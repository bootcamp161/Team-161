...
import 'package:mentorwiseasil/pages/mentor_form.dart';
import 'package:mentorwiseasil/pages/mentor_ol_page.dart';
    ...
    return ScreenUtilInit(
      builder: (context, child) => MaterialApp(
        ...
        routes: {
          ...
          '/mentorol':(context) => MentorOl(),
          '/blogyaz': (context) => BlogYaz(),
          '/mentorform' : (context) => MentorForm(),
          '/blogform' : (context) => BlogForm(),
